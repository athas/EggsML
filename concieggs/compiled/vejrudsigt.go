...
func main() {
	...
	t, _ := template.New("vejr").Parse(`Vejret i {{.City}}, {{.Country}} {{.Tidspunkt}}: {{.Beskrivelse}} med en temperatur på {{.Degrees}}°C. {{.WindBeaufortName}}, {{.WindSpeed}} m/s, fra {{.WindDirection}}.`)
