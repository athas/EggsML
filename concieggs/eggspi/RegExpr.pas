...
{$ENDIF}
 ...
 TRegExpr = class
   ...
   public
    ...
    // If true, then \E0-\FF  additional include russian letter '\B8',
    // \C0-\DF  additional include '\A8', and \E0-\DF include all russian symbols.
...
//  i : int64;
 begin
  ...
  if val < scan
   ...
   // "P \96 Q computes the difference between the address given
...
{$IFDEF UniCode}
 ...
 RusRangeLoLow = #$430{'\E0'};
 RusRangeLoHigh = #$44F{'\FF'};
 RusRangeHiLow = #$410{'\C0'};
 RusRangeHiHigh = #$42F{'\DF'};
{$ELSE}
 RusRangeLo = '\E0\E1\E2\E3\E4\E5\B8\E6\E7\E8\E9\EA\EB\EC\ED\EE\EF\F0\F1\F2\F3\F4\F5\F6\F7\F8\F9\FA\FB\FC\FD\FE\FF';
 RusRangeHi = '\C0\C1\C2\C3\C4Ũ\C6\C7\C8\C9\CA\CB\CC\CD\CE\CF\D0\D1\D2\D3\D4\D5\D6\D7\D8\D9\DA\DB\DC\DD\DE\DF';
 RusRangeLoLow = '\E0';
 RusRangeLoHigh = '\FF';
 RusRangeHiLow = '\C0';
 RusRangeHiHigh = '\DF';
...
procedure TRegExpr.SetInputString (const AInputString : RegExprString);
 ...
 begin
  ...
  !! startp/endp \E2\F1\E5 \F0\E0\E2\ED\EE \E1\F3\E4\E5\F2 \EE\EF\E0\F1\ED\EE \E8\F1\EF\EE\EB\FC\E7\EE\E2\E0\F2\FC ?
  }
